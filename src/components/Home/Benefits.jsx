    ...
    return (
        <section id="benefits" className="pt-[71px] pb-[71px]">
            <div id="container" className="max-w-[1142px] mx-auto">
                ...
                <div className="max-w-[657px] grid grid-cols-2 grid-rows-3 gap-4 p-4 bg-gray-100">
                    <div className={benefits_col}>
                        <div className="benefits__card" data-aos="fade-in" data-aos-delay="100">
                            ...
                            <p className="benefits__card-desc">Each team in our digital product agency works according to agile methodologies. Thus, we can ensure seamless and efficient development processes. We prioritize transparency, open communication, and collaboration to develop high-quality products that meet your requirements.</p>
                        </div>
                    </div>
                    <div className={benefits_col}>
                    ...
                    <div className={benefits_col}>
                        <div className="benefits__card" data-aos="fade-in" data-aos-delay="300">
                            ...
                            <p className="benefits__card-desc">Years of experience allow us to start and build projects quickly and deliver results fast. We follow a streamlined development process, ensuring that we both create new products and integrate our work seamlessly into your existing business processes.</p>
                        </div>
                    </div>
                    <div className={benefits_col}>
                        <div className="benefits__card" data-aos="fade-in" data-aos-delay="350">
                            ...
                            <p className="benefits__card-desc">We continuously optimize our processes to deliver high-quality products while reducing development costs and timelines. We use the latest tools and technologies and keep thorough time-tracking &mdash; you are only charged for the actual hour used for development.</p>
                        </div>
                    </div>
                </div>
            </div>
