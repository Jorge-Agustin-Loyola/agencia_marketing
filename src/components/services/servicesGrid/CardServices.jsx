...
const CardServices = ({key,title,description,icon}) => {
    return (
        ...
        <div name="services__col" key={key}  className="flex w-full max-w-[33.33333%] px-[10px] mt-[20px]  shadow-lg transition duration-400 ease-linear hover:translate-y-[-5px] hover:shadow-navbar" data-aos="fade-in" data-aos-delay="100">
            ...
            <a name="services__item" className="flex flex-col w-full bg-[#fff] rounded-[5px] pt-[40px] pb-[70px] px-[40px] " href="#">
                ...
                <div id="services__item-link" name="services__item-link" className="flex aling-center uppercase mt-auto text-[18px] leading-[18px] ">Learn more
                    <svg className="w-[20px] h-[15px] " viewBox="0 0 23 17">
